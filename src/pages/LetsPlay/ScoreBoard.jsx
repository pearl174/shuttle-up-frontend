...
export default function ScoreBoard() {
    const [flipTeamOne, setFlipTeamOne] = useState(false);
    const [flipTeamTwo, setFlipTeamTwo] = useState(false);
    const [teamOneScore, setTeamOneScore] = useState(-1);
    const [teamTwoScore, setTeamTwoScore] = useState(-1);
    const teamOneScoreRef = useRef(-1);
    const teamTwoScoreRef = useRef(-1);
